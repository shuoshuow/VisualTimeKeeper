...
img = cv2.imread('D:\\workspace\\VisualTimeKeeper-shuowan-froze_effect\\VisualTimeKeeper-shuowan-froze_effect\\testframe.jpg', 1)
mask = cv2.imread('D:\\workspace\\VisualTimeKeeper-shuowan-froze_effect\\VisualTimeKeeper-shuowan-froze_effect\\testmask.png', 0)
print(img.shape)
h, w, _ = img.shape
...
texture = cv2.imread('.\\VisualTimeKeeper-shuowan-froze_effect\\VisualTimeKeeper-shuowan-froze_effect\\textures\\frozen_texture.png', cv2.IMREAD_UNCHANGED)
...
generating_mask = np.zeros_like(mask)
